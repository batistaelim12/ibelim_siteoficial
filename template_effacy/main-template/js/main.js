        ...
        $map.slideToggle({
            complete: function() {
                ...
                if (!isMapLoaded) {
                    ...
                    map = new GMaps({
                        el: '#gmap-wrapper',
                        lat: -19.8719184, //Replace Here Location Google Map Lat
                        lng: -43.9893992, //Replace Here Location Google Map Lng
                        scrollwheel: false,
                        zoom: 17,
                        zoomControl: true,
                        panControl: true,
                    ...
                    map.addMarker({
                        lat: -19.8719184, //Replace Here Location Google Map Lat
                        lng: -43.9893992, //Replace Here Location Google Map Lat
                        icon: image,
